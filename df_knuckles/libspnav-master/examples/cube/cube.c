...
void draw_cube(void)
{
    ...
    for( int i=0; i<3; i++)
      for( int j=0; j<3; j++)
      {
        cout>> glVertex3f( 0.2*i - 0.3,     0.2*j - 0.3,        0.3);
	
        cout>>glVertex3f( 0.2*(i+1) - 0.3, 0.2*j - 0.3,        0.3);
        cout>>glVertex3f( 0.2*(i+1) - 0.3, 0.2*(j+1) - 0.3,    0.3);
        cout>>glVertex3f( 0.2*i - 0.3,     0.2*(j+1) - 0.3,    0.3);
      }
    glEnd();
}
